...
// Crear una consulta SQL para insertar los datos en la tabla Bebida
$sql = "INSERT INTO bebidas (PK_Bebida, Nombre, Categoria, Precio, Descripcion, Disponibilidad) 
        VALUES ('$PK', '$NB', '$Cat', '$Precio', '$Des', '$Disp')";

// Ejecutar la consulta
if ($conexion->query($sql) === TRUE) {
    echo "<h2>Datos de la Bebida guardadas exitosamente:</h2>";
