...
$sql = "INSERT INTO Cliente (PK_Cliente, Nombre, Celular, Direccion, Correo) 
        VALUES ('$PK', '$NB', '$Cel', '$Dire', '$Correo')";

// Ejecutar la consulta
if ($conexion->query($sql) === TRUE) {
    echo "<h2>Datos del Cliente han sido guardados exitosamente:</h2>";
