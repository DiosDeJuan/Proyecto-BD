...
$sql = "INSERT INTO Alimento (PK_Alimento, Nombre, Categoria, Precio, Descripcion, Disponibilidad) 
        VALUES ('$PK', '$NB', '$Cat', '$Precio', '$Des', '$Disp')";

// Ejecutar la consulta
if ($conexion->query($sql) === TRUE) {
    echo "<h2>Datos del Alimento han sido guardados exitosamente:</h2>";
