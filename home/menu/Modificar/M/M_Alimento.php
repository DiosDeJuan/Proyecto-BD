...
// Crear una consulta SQL para Modificar los datos en la tabla Alimento
$sql = "UPDATE Alimento SET Nombre = '$NB' , Categoria = '$Cat' , Precio = '$Precio' , Descripcion = '$Des' , Disponibilidad = '$Disp' WHERE PK_Alimento = '$PK'";

// Ejecutar la consulta
if ($conexion->query($sql) === TRUE) {
    echo "<h2>Datos del Alimento se han actualizado exitosamente:</h2>";
    echo "<p>El Codigo del Alimento es: " . $PK . "</p>";
    echo "<p>El Nombre del Alimento es: " . $NB . "</p>";
    echo "<p>La Categoria del Alimento es: " . $Cat . "</p>";
    echo "<p>El Precio del Alimento es: " . $Precio . "</p>";
    echo "<p>La Descripcion sobre este producto es: " . $Des . "</p>";
    echo "<p>La Disponibilidad en este Alimento es De: " . $Disp . "</p>";
} else {
